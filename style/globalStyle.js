...
const posth2Style = `text-[32px] font-bold mb-4 mt-6 border-b border-graylv2 pb-2.5 content-heading`;
...
const bloglistFirstCardImgStyle = `w-full object-cover object-center rounded-2xl overflow-hidden md:h-auto h-[200px] max-h-[400px] md:w-[49%] lg:w-[52%] shrink-0 mr-8`;
...
const bloglistCardDescriptionStyle = `text-graylv4 text-base font-normal leading-snug h-10 line-clamp-3 mb-3`;
